												...
												<?php
														...
														try {
																	...
																	while($row=mysqli_fetch_array($res))
																		{
																				echo "<p  class='prb_st'   onClick='forward_to_ranker(this.id);' id='".$row['contestid']."'> ".$row["contestid"]."</p>";}
																				echo "<div id='pagingg' >";
...
<script>
			...
			function forward_to_ranker(qid)
				{
					var id_var=qid.trim();
					window.location ="./ranker.php?id="+id_var;
				}
