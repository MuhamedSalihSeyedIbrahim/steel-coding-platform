...
<?php include'./header.php';?>
    ...
    <div id="page-wrapper" style="margin-top: -2%;padding-top: 0px; margin-left: 0px;">
        ...
        <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" id="problem_name">Challenges To Crack.</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
											...
											include '../config/db_config.php';
													...
													try {
																...
																$res=mysqli_query($link,"select * from {$statement} where contestid= '{$_REQUEST['id']}' LIMIT {$startpoint} , {$limit}");
																while($row=mysqli_fetch_array($res))
																	{
																		echo "<p  class='prb_st'   onClick='forward_to_contest(this.id);' id='".$row['question_id']."'> ".$row["question_name"]."</p>";
																	}
																		echo "<div id='pagingg' >";
...
<script>
 ...
 function   forward_to_contest(qid)
 	{
		var id_var=qid.trim();
	 	window.location ="./compiler_board.php?id="+id_var;
 	}
 </script>
